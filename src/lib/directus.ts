import { authentication, createDirectus, rest, type AuthenticationClient, type DirectusClient, type RestClient, } from '@directus/sdk';

let directus: DirectusClient<any> & RestClient<any> & AuthenticationClient<any>;

async function directusInitialization(url: string, email: string, password: string) {
